...
<link href="<c:url value="/bootstrap/css/bootstrap.min.css"/>"
	rel="stylesheet" />
<!-- Custom CSS -->
<link href="<c:url value="/bootstrap/css/heroic-features.css"/>"
	rel="stylesheet" />
...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-left">
					...
					<li><a href="http://github.com/paulograbin/DevWeb">Código
							fonte</a></li>
				</ul>
	...
	<div class="container">
		...
		<header class="jumbotron hero-spacer">
			...
			<p>Seja bem vindo ao O Editor de Texto. O que você deseja fazer
				agora?</p>
			<p>
				<a class="btn btn-primary btn-large" onclick="createEditor();">Criar
					novo texto</a>
		...
		<footer>
			<div class="row">
				<div class="col-lg-12">
					<p>Desenvolvido por Alexandre, Matheus, Paulo e Thiago. &copy;
						Editor de Texto 2015</p>
				</div>
			</div>
		</footer>
